...
from gachit.domain.entity import Mode, Sha, Tree, TreeLeaf, TreeShallow
...
class TreeShallowSerializer:
    @classmethod
    def deserialize(cls, data: bytes) -> TreeShallow:
        ...
        Returns:
            TreeShallow: deserialized tree object.
        """
        pos = 0
        length = len(data)
        root_tree = TreeShallow()
        while pos < length:
